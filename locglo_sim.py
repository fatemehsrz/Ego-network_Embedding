...
def run_network(data=None, model=None, epochs=20, batch= 32):
    try:
        ...
        csv_logger = CSVLogger('locglo_sim.log')
...
for line in feature_file:
    ...
    altersFeature.update({alter:Feature[0:500]})  
...
for i in range(len(egoList)):       
    for j in egoCircleNodes[i]:
        ...
        #print('i:',i, 'j:',j)
        con1=np.concatenate((egoVector[i], model1[str(j)]), axis=0) # loc glo sim
